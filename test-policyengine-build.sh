...
echo "   http://localhost:4173/us/obbba-household-explorer/"
echo ""
echo "🔗 Test these deep links:"
echo "   http://localhost:4173/us/obbba-household-explorer/?household=39519&baseline=tcja-expiration"
echo "   http://localhost:4173/us/obbba-household-explorer/?household=12345&baseline=tcja-extension"
echo ""
